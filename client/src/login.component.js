    ...
    render() {
            ...
            return (
                ...
                <div className="bodyC">
                    <div className="img-wrapper">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/0/0a/Emblem_of_India_%28Government_Gazette%29.svg" className="logo" />
        ...
        return (
            <div className="bodyC">
                ...
                <div className="img-wrapper">
                    <img src="https://i.pinimg.com/originals/71/6e/00/7x16e00537e8526347390d64ec900107d.png" className="logo" />
                    <div className="wine-text-container">
                        <div className="site-title wood-text">Land Registry</div>
                    </div>
                </div>
